...
- **Movimiento 1 del BOIB en curso** — estudio padre [`ESTUDIO-FUENTES-OFICIALES.md`](ESTUDIO-FUENTES-OFICIALES.md) cerrado el 2026-05-09 ([D42](DECISIONES.md)) tras respuesta del editor a las 3 preguntas de §18. Arrancamos por patrones 1+2 (espejo de promesas + detector de silencios) según el §17 del estudio. Patrón 5 (termómetro de cumplimiento) diferido a 3-6 meses con corpus. Resto de patrones documentados en §13 sin compromiso. **Dos sub-estudios encadenados antes de tocar código:** (1) clasificador oficial — [`ESTUDIO-CLASIFICADOR-OFICIAL.md`](ESTUDIO-CLASIFICADOR-OFICIAL.md) listo para arrancar §9 con prueba en seco; (2) arquitectura dual de información — [`ESTUDIO-ARQUITECTURA-DUAL.md`](ESTUDIO-ARQUITECTURA-DUAL.md) abierto el 2026-05-09 con 18 secciones cubriendo principios de la dualidad, anatomías de cinco componentes (ficha, "Lo publicado", `/normativa/`, `/sin-reflejo/`, página de actor), capa por canal, direccionamiento canónico de disposiciones y frontera con tiers/balance/correcciones. **Sigue reformulando el Hito 1** — no se cierra antes de la integración BOIB validada ([D41](DECISIONES.md)).
...
Estudios: `ESTUDIO-DISENO.md`, `ESTUDIO-COSTES-AUDITOR.md`, `ESTUDIO-TIERS.md`, `ESTUDIO-3-MODELOS.md`, `ESTUDIO-GESTION-CONOCIMIENTO.md`, `ESTUDIO-FUENTES-OFICIALES.md` (D2026-05-08), `ESTUDIO-CLASIFICADOR-OFICIAL.md` (D2026-05-08), `ESTUDIO-ARQUITECTURA-DUAL.md` (D2026-05-09), `ESTUDIOS-PENDIENTES.md`, `EXPANSION-TEMATICA.md`, `REPORTE-BENCHMARK.md`.
