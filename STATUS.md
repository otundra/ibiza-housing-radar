...
- **Hito 1 — Auditor MVP en construcción.** Fases 1, 2 y 3 cerradas 2026-04-25 (segunda lectura ciega + comparador + heurísticas + whitelist V1 + bloque `signals` con stub de tier + registro JSON + integración silenciosa + señal de disputas + `/correcciones/` mínima). Pendiente: corrida end-to-end en la próxima edición del cron (automática) y Fase 4 (prueba empírica sobre la semana W10 del 2-8 marzo 2026). Detalle en [`DISENO-AUDITOR-MVP.md §9`](DISENO-AUDITOR-MVP.md).
